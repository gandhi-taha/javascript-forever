<div align="center">
<h1> Javasript Forever: Module 05 - Arrays  </h1>
...
const countries = ['India', 'Uk', 'Sweden', 'Norway', 'USA'] // array of strings, countries
...
Countries: ['India', 'UK', 'Sweden', 'Norway', 'USA']
...
```sh
["Afghanistan", "Bolivia", "Canada", "Denmark", "Ethiopia", "France", "Germany", "Hungary", "India", "Japan", "Korea"]
```
...
const names = ['Taha', 'Shiv', 'Adam', 'Jatin']
console.log(names.toString()) // Taha,Shiv,Adam,Jatin
```
...
console.log(names.join()) // Taha,Shiv,Adam,Jatin
console.log(names.join('')) //TahaShivAdamJatin
console.log(names.join(' ')) //Taha Shiv Adam Jatin
console.log(names.join(', ')) //Taha, Shiv, Adam, Jatin
console.log(names.join(' # ')) //Taha # Shiv # Adam # Jatin
