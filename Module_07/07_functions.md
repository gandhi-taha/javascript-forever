...
function greetings(name = 'Peter') {
  let message = `${name}, welcome to JavaScript-Forever!`
  return message
}

console.log(greetings())
console.log(greetings('Taha'))
```

```js
function generateFullName(firstName = 'Taha', lastName = 'Gandhi') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
console.log(generateFullName('Vivek', 'Pavan'))
```
...
```js
const generateFullName = (firstName = 'Taha', lastName = 'Gandhi') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
const calculateAge = (birthYear, currentYear = 2021) => currentYear - birthYear
console.log('Age: ', calculateAge(1819))
```
...
[<< Module 06](../Module_06/06_loops.md) | [Module 08 >>](../Module_08/08_objects.md)
