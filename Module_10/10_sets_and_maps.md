<div align="center">
<h1> Javasript Forever: Module 10 - Sets and Maps  </h1>
...
```sh
Set(4) {"English", "Hindi", "French", "Spanish"}
```
...
console.log(langSet) // Set(4) {"English", "Hindi", "French", "Spanish"}
...
```sh
Map(3) {"India" => "New Delhi", "Germany" => "Berlin", "Uk" => "London"}
3
```
...
Uk London
```
Now you have established a big milestone, you are unstoppable. Keep going! You have just completed 10 Modules and their challenges and you are 10 steps a head in to your way to greatness. Now do some exercises for your brain and for your muscle.
...
const a = {4, 5, 8, 9}
const b = {3, 4, 5, 7}
const countries = ['India', 'Germany', 'Uk']
```
...
[<< Module 09](../Module_09/09_higher_order_functions.md) | [Module 11 >>](../Module_11/11_destructuring_and_spreading.md)
